...
type (
	...
	AccountManager interface {
		...
		Credit(accountID rhpv3.Account, amount types.Currency, fundingContract types.FileContractID, expiration time.Time, refund bool) (balance types.Currency, err error)
