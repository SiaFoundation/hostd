...
// StartIntegrityCheck starts an integrity check for the specified v1 contract.
...
// V2StartIntegrityCheck starts an integrity check for the specified v2 contract.
func (c *Client) V2StartIntegrityCheck(id types.FileContractID) error {
	return c.c.PUT(context.Background(), fmt.Sprintf("/v2/contracts/%v/integrity", id), nil)
}
