...
type (
	...
	VolumeStore interface {
		...
		MigrateSectors(ctx context.Context, volumeID int64, min uint64, migrateFn func(oldLoc, newLoc SectorLocation) error) (migrated, failed int, err error)
		...
		StoreSector(root types.Hash256, fn func(loc SectorLocation) error) (release func() error, err error)
